...
public class JobRunTest {
    ...
    public void testInsertJob() {
        ...
        Job job = new Job();
        job.setJobName("com.okay.appplatofrm.job.NewJob");
    ...
    public void testUpdateJob() {
        ...
        Job job = new Job();
        job.setId(1);
        job.setJobName("com.okay.appplatofrm.job.HelloJob");
        job.setJobGroup("test");
        job.setCron("0/6 * * * * ? ");
        job.setStatus("1");
    ...
    public void testFindJobByName() {
        ...
        List<Job> job = jobRunService.findJobByName("com.okay.appplatofrm.job.HelloJob");
        logger.info("[job]==" + JSONObject.toJSONString(job));
    }
