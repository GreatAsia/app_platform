package com.okay.appplatform.domain.report;
...
public class UiPadCaseList {
    ...
    private Long elapsedTimeForLong;


    public Long getElapsedTimeForLong() {
        return elapsedTimeForLong;
    }

    public void setElapsedTimeForLong(Long elapsedTimeForLong) {
        this.elapsedTimeForLong = elapsedTimeForLong;
    }
